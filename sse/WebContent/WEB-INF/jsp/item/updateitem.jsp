...
상품 이미지
<img id = "preview"  alt="" src="${pageContext.request.contextPath}/itemimage/${ITEM.item_image}" style="width:400px; heigth: 550px;">
</div>
<div style=" width: 400px; height: 550px; background-color: gray; margin-left: 25%;">
추가 이미지
<img id = "preview2"  alt="" src="${pageContext.request.contextPath}/additemimage/${ADD.item_add_image}" style="width:400px; heigth: 550px;">	
</div>

<div style="position:relative;">
	<form action="../item/updateItem.html" method ="post" enctype="multipart/form-data" onsubmit="return checking();">
		<table id = "ADDITEM">
			<tr>
				<td>상품타입 : </td>
				<td><select name="TYPE">
			...
			<tr>
				<td>상품가격 : </td>
				<td><input type= "text" name ="PRICE" value="${ITEM.item_price }"></td>
			</tr>
			<tr>
				<td>상품세일 : </td>
				<td><input type = "text" name = "SALE" value="${ITEM.item_sale }">%</td>
			</tr>
			<tr>
				<td>상품이미지 :</td>
			...
			<tr>
				<td>상품정보 : </td>
				<td><input type = "text" name = "INFO" value = "${ITEM.item_info }"></td>
			</tr>
			<tr>
				<td>성별 :</td>
			...
			<tr>
				<td>색상 :</td>
				<td><input type ="text" name = "COLOR" value = "${COUNT.item_count_color }">[색상이 복수일 경우 ","로 구별해주세요.]
			<tr>
			<tr>
				<td>수량 :</td>
				<td><input type = "text" name ="COUNT" value = "${COUNT.item_count_count }"></td>
			</tr>
			<tr>
				<td><input type ="hidden" name = "CODE" value = "${ITEM.item_code }"></td>
			</tr>
			<tr>
				<td><input type = "hidden" name = "itemType" value = "${itemType }"></td>
			</tr>
		</table>
